...
Arp.prototype.request = function(address) {
  ...
  arpBuffer.setMacSource(this._interface);
  arpBuffer.setSourceHardwareAddress(this._interface);
...
Arp.prototype._getIPv4ProtocolAddress = function() {
  return this._getInterface().address;
...
Arp.prototype._getInterface = function() {
  var interface = _.findWhere(interfaces()[this._device], {
    family:'IPv4'
  });
  return interface;
}
